...
def import2standalone(args):
	'''
	Import all experiment tasks and these tasks will have its newly generated id by the standalone ClearML.
...
def get_args():
	...
	parser.add_argument('--output-uri', default='http://192.168.50.1:8081', help='')
	parser.add_argument('--deploy-info', default='deploy.json', help='This is the json file that contains tasks, models and datasets to be imported to the standalone ClearML.')
	parser.add_argument('--tasks-folder', default='tasks', help='This is where the tasks are.')
	parser.add_argument('--models-folder', default='models', help='This is where the models are.')
	parser.add_argument('--datasets-folder', default='datasets', help='This is where the datasets are.')
